	...
	if (isset($_REQUEST["BtnSave"]))
	 {
		...
		// {
		 $Query= "INSERT INTO rentalproperty (code, name, description,
         ...
         header("local:rental_property.php");
		 //echo $Query;
					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="rental_property.php" method="post" enctype="multipart/form-data"> 
