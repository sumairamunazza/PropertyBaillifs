        ...
        <div class="jumbotron" style="background: white;">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h5>
                        Are you looking for Selling Property?
                    </h5>
                </div>
      ...
      <div id="content" class="content full">
        <div class="container">
          <div class="row">
            ...
            imagelocation FROM sellingproperty WHERE status = 1 Order By id";
            ...
            while ($row = mysqli_fetch_array($result1))
            {
                ...
                <div class="col-md-4">
                    ...
                    <br>
                    <img class="img-responsive" src="<?php echo $row['imagelocation'];?>" alt="Images" height="300px" width="300px">
                    <br>
                    <center>
                        <a href="contact.php">
